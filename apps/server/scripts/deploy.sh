...
#   ./apps/server/scripts/deploy.sh                          # build then deploy (test)
#   ./apps/server/scripts/deploy.sh --prod prod              # build then deploy (prod)
#   ./apps/server/scripts/deploy.sh deploy                   # deploy already-built zip, no rebuild (test)
