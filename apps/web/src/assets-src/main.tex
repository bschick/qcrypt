...
\begin{tabular}{@{}p{2mm} l}
\multicolumn{2}{@{}l}{$h_E = E_a(h,n_{IVH},k_H)$}\\
...
\multicolumn{2}{@{}l}{$t = H(v, l, ad_F \mathbin\Vert m_E, t_L, k_S)$}\\
...
&$k_S = D_H(1,kp_S,H(n_S,a,v,lp,u_c))$\\
&$b = V(v, l, ad_F \mathbin\Vert m_E, t_L, k_S, t)$\\
&$t_L = t$\\
&$\textrm{if }!b:$\\
&\hspace{15pt}$A \leftarrow B: err$\\
&$n_{IVH} = D_H(2,kp_H,H(n_S,a,v,lp,n_{IV}))$\\
&$k_H = D_H(1,kp_H,H(n_S,a,v,lp,u_c))$\\
&$h = E_a^{-1}(h_E,n_{IVH},k_H)$\\
&$B \rightarrow A: h$\\
&$B \leftarrow A: p$\\
&$k_{M0} = D_P(p \mathbin\Vert u_c \mathbin\Vert a \mathbin\Vert v \mathbin\Vert lp,n_S,i)$\\
&$k_C = D_H(1,kp_C,H(n_S,k_{M0}))$\\
...
\multicolumn{2}{@{}l}{$b = V(v, l, ad_F \mathbin\Vert m_E, t_L, k_S, t)$}\\
\multicolumn{2}{@{}l}{$t_L = t$}\\
...
\multicolumn{2}{@{}l}{$l = len(ad_F \mathbin\Vert m_E)$}\\
\multicolumn{2}{@{}l}{$t = H(v, l, ad_F, m_E, \mathtt{0x00}, k_S)$}\\
\multicolumn{2}{@{}l}{$cd = t \mathbin\Vert v \mathbin\Vert l \mathbin\Vert ad_F \mathbin\Vert m_E$}\\
\end{tabular}
...
\multicolumn{2}{@{}l}{$B \leftarrow \textrm{session storage}: cd$}\\
\multicolumn{2}{@{}l}{$t, v, l, ad_F, m_E = cd$}\\
\multicolumn{2}{@{}l}{$f, a, n_{IV}, n_S, i, le, lp, h_El = ad_F$}\\
\multicolumn{2}{@{}l}{$k_S = D_H(1, kp_S, H(n_S, a, v, lp, u_i, k_L))$}\\
\multicolumn{2}{@{}l}{$b = V(v, l, ad_F, m_E, \mathtt{0x00}, k_S, t)$}\\
\multicolumn{2}{@{}l}{$\textrm{if }!b:$}\\
\multicolumn{2}{@{}l}{\hspace{15pt}$A \leftarrow B: err$}\\
\multicolumn{2}{@{}l}{$k_M = D_H(0, kp_M, H(n_S, a, v, lp, u_i, k_L))$}\\
\multicolumn{2}{@{}l}{$k_C = D_H(1, kp_C, H(n_S, k_M))$}\\
...
\multicolumn{2}{@{}l}{$S\textrm{ verify signature, store }rr \textrm{, generate }u_c \textrm{ and } u_r \textrm{, remove }ch $} \\
& $u_c = R(256)$\\
& $u_r = R(128)$\\
...
\multicolumn{2}{@{}l}{$S\textrm{ verify } u_r \textrm{, delete existing }rr \textrm{, create and store}: $} \\
& $ch = R(256)$\\
\multicolumn{2}{@{}l}{$B\leftarrow S : ro$} \\
\multicolumn{2}{@{}l}{$B\rightarrow M : ro$} \\
\multicolumn{2}{@{}l}{$A\rightarrow M : cw$} \\
