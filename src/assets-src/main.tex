...
\usepackage[letterpaper,top=1cm,bottom=1cm,left=0cm,inner=0cm,right=1cm,marginparwidth=0cm]{geometry}
\usepackage{amsmath}
\usepackage{graphicx}
...
\multicolumn{2}{@{}l}{$A\rightarrow B: m,i,a,le$}\\
...
&$cd = cd_0\mathbin\Vert  cd_N\mathbin\Vert ...$\\
&$m = cd$\\
&$lp = lp + 1$\\
...
\begin{tabular}{@{}p{2mm} l}
\multicolumn{2}{@{}l}{$k_H = D_H(u_c,n_S,kp_H = \textrm{``hint encryption key''})$}\\
...
\multicolumn{2}{@{}l}{$m_E = E_a(m_0,n_{IV},ad,k_M)$}\\
\multicolumn{2}{@{}l}{$pl = len(ad \mathbin\Vert m_E)$}\\
\multicolumn{2}{@{}l}{$t = H(v, pl, ad, m_E, k_S)$}\\
\multicolumn{2}{@{}l}{$cd_0 = t\mathbin\Vert v\mathbin\Vert pl\mathbin\Vert ad \mathbin\Vert m_E$}\\
\end{tabular}
...
\begin{tabular}{@{}p{2mm} l}
\multicolumn{2}{@{}l}{$r = G(384)\lor B\overset{\textrm{https}}{\leftarrow} R: r$}\\
\multicolumn{2}{@{}l}{$n_{IV} = r[0:l)$}\\
\multicolumn{2}{@{}l}{$ad = a \mathbin\Vert n_{IV}$}\\
\multicolumn{2}{@{}l}{$m_E = E_a(m_N,n_{IV},ad,k_M)$}\\

\multicolumn{2}{@{}l}{$pl = len(ad \mathbin\Vert m_E)$}\\
\multicolumn{2}{@{}l}{$t = H(v, pl, ad, m_E, k_S)$}\\
\multicolumn{2}{@{}l}{$cd_N = t\mathbin\Vert v\mathbin\Vert pl\mathbin\Vert 
ad \mathbin\Vert m_E$}\\
\end{tabular}
...
\begin{tabular}{@{}p{2mm} l}
\multicolumn{2}{@{}l}{$m_o = E_a^{-1}(m_E, n_{IV},ad,k_M)$}\\
\end{tabular}
...
\begin{tabular}{@{}p{2mm} l}
\multicolumn{2}{@{}l}{$t,v,pl,ad,m_E=cd_N$}\\
\multicolumn{2}{@{}l}{$a,n_{IV}=ad$}\\
\multicolumn{2}{@{}l}{$b = V(v, pl, ad, m_E, k_S, t)$}\\
\multicolumn{2}{@{}l}{$\textrm{if }!b:$}\\
\multicolumn{2}{@{}l}{\hspace{15pt}$A \leftarrow B: err$}\\
\multicolumn{2}{@{}l}{$m_N = E_a^{-1}(m_E, n_{IV},ad,k_M)$}\\
\end{tabular}
